...
void init_student_array() {
	*(st_pos_fn + 0) = 201218035;
	*(st_pos_fn + 1) = 201218051;
	*(st_pos_fn + 2) = 201218055;
	*(st_pos_fn + 3) = 201218053;
	*(st_pos_fn + 4) = 201218059;
	*(st_pos_fn + 5) = 201218034;
	*(st_pos_fn + 6) = 201218054;
	*(st_pos_fn + 7) = 201218049;
	*(st_pos_fn + 8) = 201218041;
	*(st_pos_fn + 9) = 201218060;
	*(st_pos_fn + 10) = 201218042;
	*(st_pos_fn + 11) = 201218040;
	*(st_pos_fn + 12) = 201218004;
}
